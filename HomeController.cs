...
namespace WebApplication1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.str = getAnalyticsData(profileID, serviceAccountEmail);
            return View();
        }

        public string getAnalyticsData(string ProfileID, string serviceAccountEmail)
        {
            ...
            var request = GoogleAnalyticsService.Data.Ga.Get("ga:" + ProfileID, "2016-12-01", "2016-12-02", "ga:visitors,ga:newVisits,ga:percentNewVisits");

            //var request = GoogleAnalyticsService.Data.Ga.Get("ga:" + ProfileID, "2016-01-01", "2016-12-12", "ga:visits");
